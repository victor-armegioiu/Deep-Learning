...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # Backward pass, get gradients wrt all weights and biases.
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers, 0, -1):
            ...
            if i == self.num_layers:
                dout, grads[W_name], grads[b_name] = affine_backward(dout, caches.pop())
            else:
                dout, grads[W_name], grads[b_name] = affine_relu_backward(dout, caches.pop())
